...
<div class="col-md-12">
    <div class="card card-primary">
        <div class="card-header with-border">
            ...
            <a type="" class="btn btn-success btn float-left" style="" href="{{ route('prediksi.masuk') }}"><i
                    ...
                    <form action="{{ route('prediksi.store') }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label>Nilai Produk Masuk Terbesar </label>
                                    <input readonly type="number" name="" id="max_purchase" class="form-control"
                                        value="{{ old('permintaan') }}">
                            </div>
                            <div class="form-group">
                                <label>Nilai Produk Keluar Terbesar </label>
                                <input readonly type="number" name="persediaan_tertinggi" id="" class="form-control"
                                    value="{{ old('persediaan') }}">

                            </div>
                            <div class="form-group">
                                <label>Pembelian | Purchases </label>
                                <input readonly type="number" name="pembelian_tertinggi" id="" class="form-control"
                                    value="{{ old('pembelian') }}">
                            </div> --}}
                        </div>
                        <div class="col-md-8">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>Permintaan | Sales</label>
                                <input readonly type="number" name="permintaan_terendah" id="" class="form-control"
                                    value="{{ old('client_name') }}">
                            </div>
                            <div class="form-group">
                                <label>Persediaan | Stocks</label>
                                <input readonly type="number" name="persediaan_terendah" id="" class="form-control"
                                    value="{{ old('client_name') }}">
                            </div>
                            <div class="form-group">
                                <label>Pembelian | Purhcases</label>
                                <input readonly type="number" name="pembelian_terendah" id="" class="form-control"
                                    value="{{ old('client_name') }}">
                            </div>
                        </div>
